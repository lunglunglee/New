...
namespace DataServicesWebApp
{
    ...
    public partial class AdventureWorksLTEntities : ObjectContext
    {
        ...
        /// <summary>
        /// 使用在應用程式組態檔的 'AdventureWorksLTEntities' 區段中找到的連接字串，初始化新的 AdventureWorksLTEntities 物件。
        /// </summary>
        ...
        /// <summary>
        /// 初始化新的 AdventureWorksLTEntities 物件。
        /// </summary>
        ...
        /// <summary>
        /// 將新物件加入 Addresses EntitySet 的方法已被取代。請考慮改為使用關聯的 ObjectSet&lt;T&gt; 屬性的 .Add 方法。
        /// </summary>
        ...
        /// <summary>
        /// 將新物件加入 CustomerAddresses EntitySet 的方法已被取代。請考慮改為使用關聯的 ObjectSet&lt;T&gt; 屬性的 .Add 方法。
        /// </summary>
        ...
        /// <summary>
        /// 將新物件加入 ProductCategories EntitySet 的方法已被取代。請考慮改為使用關聯的 ObjectSet&lt;T&gt; 屬性的 .Add 方法。
        /// </summary>
        ...
        /// <summary>
        /// 將新物件加入 ProductDescriptions EntitySet 的方法已被取代。請考慮改為使用關聯的 ObjectSet&lt;T&gt; 屬性的 .Add 方法。
        /// </summary>
        ...
        /// <summary>
        /// 將新物件加入 ProductModels EntitySet 的方法已被取代。請考慮改為使用關聯的 ObjectSet&lt;T&gt; 屬性的 .Add 方法。
        /// </summary>
        ...
        /// <summary>
        /// 將新物件加入 ProductModelProductDescriptions EntitySet 的方法已被取代。請考慮改為使用關聯的 ObjectSet&lt;T&gt; 屬性的 .Add 方法。
        /// </summary>
        ...
        /// <summary>
        /// 將新物件加入 SalesOrderDetails EntitySet 的方法已被取代。請考慮改為使用關聯的 ObjectSet&lt;T&gt; 屬性的 .Add 方法。
        /// </summary>
        ...
        /// <summary>
        /// 將新物件加入 SalesOrderHeaders EntitySet 的方法已被取代。請考慮改為使用關聯的 ObjectSet&lt;T&gt; 屬性的 .Add 方法。
        /// </summary>
    ...
    public partial class Address : EntityObject
    {
        ...
        /// <param name="stateProvince">StateProvince 屬性的初始值。</param>
        /// <param name="countryRegion">CountryRegion 屬性的初始值。</param>
    ...
    public partial class Customer : EntityObject
    {
        ...
        /// <param name="passwordHash">PasswordHash 屬性的初始值。</param>
        /// <param name="passwordSalt">PasswordSalt 屬性的初始值。</param>
        /// <param name="rowguid">rowguid 屬性的初始值。</param>
        /// <param name="modifiedDate">ModifiedDate 屬性的初始值。</param>
    ...
    public partial class CustomerAddress : EntityObject
    {
        ...
        /// <summary>
        /// 建立新 CustomerAddress 物件。
        /// </summary>
        /// <param name="customerID">CustomerID 屬性的初始值。</param>
        /// <param name="addressID">AddressID 屬性的初始值。</param>
        /// <param name="addressType">AddressType 屬性的初始值。</param>
        /// <param name="rowguid">rowguid 屬性的初始值。</param>
        /// <param name="modifiedDate">ModifiedDate 屬性的初始值。</param>
    ...
    public partial class Product : EntityObject
    {
        ...
        /// <param name="productNumber">ProductNumber 屬性的初始值。</param>
        /// <param name="standardCost">StandardCost 屬性的初始值。</param>
        /// <param name="listPrice">ListPrice 屬性的初始值。</param>
        /// <param name="sellStartDate">SellStartDate 屬性的初始值。</param>
        /// <param name="rowguid">rowguid 屬性的初始值。</param>
        /// <param name="modifiedDate">ModifiedDate 屬性的初始值。</param>
    ...
    public partial class ProductCategory : EntityObject
    {
        ...
        /// <summary>
        /// 建立新 ProductCategory 物件。
        /// </summary>
        /// <param name="productCategoryID">ProductCategoryID 屬性的初始值。</param>
        /// <param name="name">Name 屬性的初始值。</param>
        /// <param name="rowguid">rowguid 屬性的初始值。</param>
        /// <param name="modifiedDate">ModifiedDate 屬性的初始值。</param>
    ...
    public partial class ProductDescription : EntityObject
    {
        ...
        /// <summary>
        /// 建立新 ProductDescription 物件。
        /// </summary>
        /// <param name="productDescriptionID">ProductDescriptionID 屬性的初始值。</param>
    ...
    public partial class ProductModel : EntityObject
    {
        ...
        /// 建立新 ProductModel 物件。
        /// </summary>
        /// <param name="productModelID">ProductModelID 屬性的初始值。</param>
        /// <param name="name">Name 屬性的初始值。</param>
        /// <param name="rowguid">rowguid 屬性的初始值。</param>
        /// <param name="modifiedDate">ModifiedDate 屬性的初始值。</param>
    ...
    public partial class ProductModelProductDescription : EntityObject
    {
        ...
        /// <summary>
        /// 建立新 ProductModelProductDescription 物件。
        /// </summary>
        /// <param name="productModelID">ProductModelID 屬性的初始值。</param>
        /// <param name="productDescriptionID">ProductDescriptionID 屬性的初始值。</param>
        /// <param name="culture">Culture 屬性的初始值。</param>
        /// <param name="rowguid">rowguid 屬性的初始值。</param>
        /// <param name="modifiedDate">ModifiedDate 屬性的初始值。</param>
    ...
    public partial class SalesOrderDetail : EntityObject
    {
        ...
        /// <summary>
        /// 建立新 SalesOrderDetail 物件。
        /// </summary>
        /// <param name="salesOrderID">SalesOrderID 屬性的初始值。</param>
        /// <param name="salesOrderDetailID">SalesOrderDetailID 屬性的初始值。</param>
        /// <param name="orderQty">OrderQty 屬性的初始值。</param>
        /// <param name="unitPrice">UnitPrice 屬性的初始值。</param>
        /// <param name="unitPriceDiscount">UnitPriceDiscount 屬性的初始值。</param>
        /// <param name="lineTotal">LineTotal 屬性的初始值。</param>
        /// <param name="rowguid">rowguid 屬性的初始值。</param>
        /// <param name="modifiedDate">ModifiedDate 屬性的初始值。</param>
    ...
    public partial class SalesOrderHeader : EntityObject
    {
        ...
        /// <param name="shipMethod">ShipMethod 屬性的初始值。</param>
